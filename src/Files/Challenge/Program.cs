...
// Horizontal Line for cleaner look
string horizontalRule = new('-', Math.Abs(columnSize) * 3);

// <Start> Creating the Result Text
string resultText = "\nSUMMARY\n\n";
resultText += $"{"File Type",-columnSize}{"Count",-columnSize}{"Size",columnSize}\n";
resultText += $"{horizontalRule}\n";
